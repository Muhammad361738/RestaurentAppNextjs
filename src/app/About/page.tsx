        ...
        <div className='bg-black  bg-opacity-80 h-screen max-w-screen-sm pb-10'>
                ...
                <div className='flex flex-wrap  items-center justify-center md:justify-between  h-screen w-screen pb-10 '>
                     <div className=' mt-5  w-64 h-auto  lg:w-96 m-5 md:w-64 lg:m-10  md:m-10 pb-10'>
                        ...
                        <p className='text-sm text-white md:font-'>Welcome to Restaurently your go-to destination for nutritious and delicious meals! We believe that healthy eating should never compromise on flavor. Our menu is thoughtfully crafted using fresh, organic ingredients, offering a variety of wholesome options that nourish both body and soul</p>
                        <p className='text-sm text-white md:font-'>Welcome to Restaurently where flavor meets tradition! We are dedicated to serving delicious, high-quality meals crafted from the freshest ingredients. Our menu is a celebration of diverse cuisines, blending rich flavors and modern twists.</p>
                        <p className='text-sm text-white md:font-'>Our culinary team takes pride in crafting dishes that not only satisfy but also tell a story of flavor and creativity. Whether its a casual meal with friends or a special occasion, we aim to make every visit memorable. Experience dining that delights all your senses</p>
                        <p className='text-sm text-white md:font-'>Located in the heart of City/Area Name Restaurantly offers the perfect spot for both locals and visitors. Easily accessible and surrounded by the vibrant energy of the city our restaurant provides a cozy escape amidst the hustle and bustle</p>
                     </div>
                     <div className=''>
